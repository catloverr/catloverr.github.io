			...
			<xsl:for-each select="sitemap:sitemapindex/sitemap:sitemap">
				<tr>
					...
					<td>
						...
						<a href="http://media.newgenmadness.com/wp2/wp-content/plugins/all-in-one-seo-pack/inc/{$itemURL}">
							<xsl:value-of select="sitemap:loc"/>
						</a>
					</td>
					<td>
				...
				<tr>
					...
					<td>
						...
						<xsl:if test="$thumbURL != ''">
							<a href="http://media.newgenmadness.com/wp2/wp-content/plugins/all-in-one-seo-pack/inc/{$playURL}"><img src="http://media.newgenmadness.com/wp2/wp-content/plugins/all-in-one-seo-pack/inc/{$thumbURL}" style="max-width:60px;float:right;"/></a>
						</xsl:if>
					</td>
					<td>
